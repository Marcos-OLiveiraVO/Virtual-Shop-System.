...
describe("Controller: Users", () => {
  ...
  it("should return 400 when an error occurs", async () => {
    ...
    describe("getById()", () => {
      it("should call with one user", async () => {
    ...
    describe("update() user", () => {
      it("should respond with 200 when a new user has been updated", async () => {
        const fakeId = "a-fake-id";
    ...
    describe("delete() user", () => {
      it("should respond with 204 when the use has been deleted", async () => {
        const fakeId = "a-fake-id";
